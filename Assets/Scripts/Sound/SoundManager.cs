...
public class SoundManager : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip lowFuelAlarmClip;
    ...
    private AudioSource fuelAlarmSource;
    ...
    private void Awake() 
    {
        ...
        fuelAlarmSource.clip = lowFuelAlarmClip;
        fuelAlarmSource.loop = true;
        fuelAlarmSource.playOnAwake = false;

        OnSoundVolumeChanged += (sender, e) => 
        {
            if (fuelAlarmSource != null) 
            {
                fuelAlarmSource.volume = GetSoundVolumeNormalized();
            }
        };
    }
    ...
    public void PlayCannonShotSound(Vector3 position)
{
    ...
    public void PlayLowFuelAlarm()
    {
        float alarmVolumeMultiplier = 0.3f;
        fuelAlarmSource.volume = GetSoundVolumeNormalized() * alarmVolumeMultiplier;
